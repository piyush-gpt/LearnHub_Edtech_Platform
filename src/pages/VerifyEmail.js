...
function VerifyEmail() {
    ...
    function handleSubmit(e){
        e.preventDefault();
        dispatch(resetPassword(signupData.password,signupData.confirmPassword,otp,signupData.email,navigate))
    }
    function handleResend(){
        dispatch(getPasswordResetToken(signupData.email,navigate));
    }
  return (
